...
```text
input:
รับค่าเลขที่ต้องการเอามาหาร
output :
แสดงเลขตั้งแต่หาร10ครั้งแรกไปจนถึง0แล้วหยุด
constraints :
ไม่มี
```
...
```text
Step 1:รับเลข
Step 2:เอามาหารปัดเศษลงเพื่อให้ได้หลัก10
Step 3:ทำลูปเพื่อแสดงเลข
Step 4:ปิดทายด้วยเลข0
```
