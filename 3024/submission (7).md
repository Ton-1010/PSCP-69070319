...
```text
input:
รับค่าคะแนนทั้งหมด รับค่าคะแนนสูงสุด
output:
ให้แสดงSurprising ถ้ามีโอกาส
...
```text
Step 1:รับค่าทั้งหมด และค่ามากที่สุด คนละบรรทัด
Step 2:คำนวณหาค่าคะแนนขั้นต่ำ
Step 3 : ตรวจสอบเงื่อนไข
Step 4 : แสดงค่า "Surprising" หรือ "Not surprising"
```
...
```text
ใช้ตามวิธีแรกเลยตรงเงื่อนไขฉันตั้งเอาคะแนนมากสุดลบคะแนนน้อยสุดแล้วเช็คว่า>2ไหม
```
