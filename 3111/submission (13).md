...
```text
input : รับค่าสมาชิก รับค่าจำนวณรายการสินค้า รับค่าราคาของ
output : ยอดเงินทั้งหมดที่ต้องจ่าย
...
```text
Step 1 :นำเข้าโมดูล
Step 2 :รับค่าข้อมูลสมาชิก
Step 3 :ทำลูปรับราคาสินค้า
Step 4 :ตรวจสอบเงื่อนไขเพื่อคำนวณส่วนลด
Step 5 :ปัดเศษทศนิยมและแสดงผล
```
...
```text
ไม่เป็นสมาชิก และยอดรวม >= 500 บาท
```
