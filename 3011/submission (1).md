...
รับชื่อสี 2 อัน
Output:
ชื่อสีที่ได้หลังผสม หรือ Error
Constraints:
ไม่มี
```
...
```text
Step 1: รับค่าสีทั้ง2ค่า
Step 2:เอาสีทั้ง2มาตรวจสอบว่าตรงกับเงื่อนไขไหนที่ตั้งไว้
Step 3:ถ้าเป็นไปตามเงื่อนไขที่กำหนดไว้ให้แสดงสีที่ผสมได้
Step 4:ถ้าไม่เป็นไปตามเงื่อนไงให้แสดง Error
ก่อนถามเพื่อนฉันไม่ได้คิดเงื่อนไขที่สีทั้ง 2 อาจเป็นสีเดียวกันได้
```
...
```text
เหมือนแผนแรกเพราะเป็นการสร้างเงื่อนไขเพื่อตรวจสอบว่าตรงกะับที่เราตั้งไว้ไหม
```
