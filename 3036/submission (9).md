...
รับค่าตัวเลข
output:
แสดงจำนวนกำแพงที่ต้องพังน้อยที่สุด
Constraints:
งงตอนจะคำนวน
```
...
```text
Step 1 : รับค่าตำแหน่งเริ่มต้น(N)
Step 2 : เช็คเงื่อนไขว่า N = 1 ไหมถ้าเท่าแสดง 0
Step 3 : ถ้าไม่ใช้ให้หาว่าอยู่ชั้นไหน
Step 4 : แสดงค่ากำแพงที่ทำลาย
```
...
```text
ใช้ตามแผนแรกในStep 1 -Step 3 ส่วนStep 4 ได้เพิ่มการหาพิกัดตำแหน่งในชั้นแล้วเช็คว่าเป็นคู่หรือคี่เพื่อคำนวณและแสดงผลออกมา
```
