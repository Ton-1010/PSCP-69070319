...
```text
Input:
รับค่าจน.เงินรวมของอาหารและเครื่องดื่ม
Output:
จำนวนเงินที่ลูกค้าต้องชำระทั้งหมด
Constraints:
 ไม่ค่อยเข้าใจโจทย์
...
Step 2: หาค่าบริการ
Step 3: เอาผลรวม2ค่าแรกมาบวกกับค่าภาษีอีก 7%
Step 4:แสดงค่าที่ต้องชำระทั้งหมดเป็นทศนิยม 2 ตำแหน่ง 

ก่อนถามเพื่อนฉันไม่เข้าใจว่าจะต้องทำยังไงให้สามารถคำนวนได้ตามที่ต้องการ
...
```text
หาค่าบริการ แล้วหาค่าผลรวมของบริการและอาหาร แล้วเอาผลรวมไปหาภาษี 7% แล้วเอาค่าทั้ง 2 มารวมกัน
```
...
```text
สอนว่าจะต้องใช้วิธีการคิดคำนวณแบบไหน
```
