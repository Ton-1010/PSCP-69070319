...
output:
โปรแกรมควรแสดงคำที่รับไปนั้นแบบกลับคำจากด้านหลังมาด้านหน้าและทุกตัวในคำเป็นพิมพ์เล็ก
Constraints:
ไม่มี
```
...
```text
1: รับคำที่ต้องการให้สลับที่
2: ทำให้คำทุกตัวเป็นพิมพ์เล็กแล้วค่อยกลับหน้าหลังคำต่อ
3: ให้พิมพ์คำที่ถูกกลับหน้าหลังแล้วและทุกคำเป็นตัวพิมพ์เล็กหมดแล้ว

ก่อนถามเพื่อนฉันไม่รู้ว่าจะใช้คำสั่งอะไรเพื่อจะสลับตำแหล่งของคำ
```
...
```text
ใช้คำสั่ง .lower() ทำให้ทุกคำเป็นตัวพิมพ์เล็กแล้วใช้ [::-1] ในการจัดการกลับหน้าหลัง
```
...
```text
เป็นตัวอักษรตัวใหญ่คนละตำแหน่งกัน
```
...
```text
แนะนำว่าต้องใช้อะไรถึงจะสลับที่คำได้
```
