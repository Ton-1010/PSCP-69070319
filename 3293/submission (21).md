...
```text
Step 1 : รับค่า
Step 2 : หาค่าที่ยาวที่สุด
Step 3 :พิมพ์เส้นขอบบน
Step 4 : แสดงคำตอบค่าที่ตรวจสอบได้
Step 5 :พิมพ์เส้นขอบล่าง
```
...
```text
ข้อความทั่วไปที่มีความยาวต่างกัน
```
...
```text
ข้อความสั้นและความยาวเท่ากันทั้งหมด
```
