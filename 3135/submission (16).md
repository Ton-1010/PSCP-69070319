...
```text
Step 1: รับค่าตัวเลข
Step 2: ทำลูปส่งของขวัญไปเรื่อยๆ ตราบใดที่ยังส่งไม่ถึงมือขโมย
Step 3: แสดงผล
```
...
```text
ของขวัญถึงเป้าหมาย (T) ในไม่กี่ขั้นตอน
```
...
```text
ของขวัญส่งวนรอบวงกลมแล้วเจอเป้าหมาย
```
...
```text
ส่งของขวัญวนกลับมาที่จุดเริ่มต้น
```
...
```text
ตรวจสอบว่าลืมเขียนอะไรในโค้ดที่เขียนถึงไม่ผ่าน
```
