...
```text
input:
รับค่าใหญ่ เล็ก พื้นที่
output :
ถ้าทำได้ให้ตอบใช้ก้อนเล็กกี่ก้อน แต่ถ้าไม่ได้ให้แสดง -1
constraints :
คำนวณจน.ไม่ถูก
```
...
```text
Step 1: รับค่า
Step 2: คำนวณจนอิฐ.ที่ต้องใช้
Step 3:แสดงว่าได้หรือไม่ถ้าได้แสดงจน.อิฐเล็กที่ใช้ ถ้าไม่แสดง -1  
```
...
```text
ก้อนใหญ่เป็น 0 แล้วก้อนเล็กพอดีกับพื้นที่
```
...
```text
ก้อนใหญ่เป็น 0 แล้วก้อนเล็กไม่พอดีกับพื้นที่
```
...
```text
ใช้ก้อนใหญ่อย่างเดียวแล้วพอกับพื้นที่
```
