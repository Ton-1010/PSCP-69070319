...
```text
input:
รับค่า 3 ค่า ตัวเลข ตัวอักษร ตัวอักษร คนละบรรทัด
output:
แสดงค่าอุณหภูมิเป็นหน่วยที่เราต้องการ
constraints:
ไม่มี
```
...
```text
Step 1:รับค่า 3 ค่า ตัวเลข ตัวอักษร ตัวอักษร คนละบรรทัด
Step 2:สร้างเงื่อนไขเพื่อตรวจสอบและแปลงค่าอุณหภูมิจากหน่วยที่ได้รับมาให้เป็นหน่วยที่เราต้องการ
Step 3:แสดงค่าของอุณหภูมิในหน่วยที่เราต้องการและเป็นทศนิยม 2 ตน.
```
...
```text
ใช้ตามแผนแรกทำเงื่อนไขเพื่อตรวจสอบและคำนวณทีละอันตามหน่วยที่ต้องการเปลี่ยน
```
...
```text
ตรวจสอบว่าโปแกรมทำงานได้ตามเงื่อนไขถูกต้องหรือไม่
```
...
```text
-40 เป็นอุณหภูมิพิเศษที่เป็นจุดบรรจบกันพอดีระหว่างหน่วยFarenheitและCelsius 
```
