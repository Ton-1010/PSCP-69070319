...
```text
input : รับค่าตัวเลขเริ่มต้นและสิ้นสุด
output : แสดงค่า
...
```text
Step 1 : รับค่าตัวเลขเริ่มต้นและสิ้นสุด
Step 2 :ทำลูปเช็คตัวเลขทีละตัวตั้งแต่เริ่มต้นจนถึงสิ้นสุด
Step 3 : นำจำนวนเฉพาะที่ได้มาพิมพ์ทีละตัว
Step 4 : แสดงจำนวนของตัวเลขเฉพาะว่ามีทั้งหมดกี่ตัว
```
...
```text
ช่วยดูว่าเขียนอะไรตกไปในโค้ดถึงไม่ผ่าน
```
