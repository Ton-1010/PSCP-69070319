...
```text
Step 1:รับค่าจำนวนเต็ม X , Y
Step 2:ทำตัวแปรเก็บค่า
Step 3:ทำลูปกระโดด
Step 4:ทำเงื่อนไขเพื่อตรวจสอบว่าระยะกระโดดหมดรึยัง
Step 5:คำนวณการกระโดดในแต่ละรอบ
Step 6:แสดงผลเมื่อจบ
```
...
```text
ช่วยอธิบายตรงลูปว่าควรต้องทำยังไง
```
