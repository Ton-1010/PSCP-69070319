...
```text
Step 1 : รับค่าความเร็ว,รับค่าจำนวนบ้าน
Step 2 : ลูปจนกว่าจะครบจำนวนบ้าน
Step 3 : รับพิกัดบ้านในแต่ละครั้ง
Step 4 : คำนวณพื้นที่วงกลมของบ้านหารด้วยความเร็วปัดขึ้นแล้วแสดงผล
```
