...
```text
input : รับค่ายจำนวณร้านและช่วงเวลาที่ต้องการดูรับค่าเวลาเปิดปิดร้าน
output : แสดงค่า
constraints : การทำให้เห็นภาพ
```
...
```text
Step 1 : รับค่าเริ่มต้นและสร้าง Array ส่วนต่าง
Step 2 :บันทึกช่วงเวลาเปิด-ปิดของร้านค้า
Step 3 : คำนวณจำนวณร้านค้าที่เปิดอยู่จริง ณ แต่ละนาที
Step 4 : แสดงค่า 
```
