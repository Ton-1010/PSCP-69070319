...
```text
input : รับค่าต้นทาง - ปลายทาง และ น้ำหนักของ
output : แสดงค่าส่ง หรือ Error
Constraints : ไม่มีครับ
...
```text
Step 1:รับค่าต้นทาง - ปลายทาง
Step 2:รับค่าน้ำหนักของ
Step 3:ตรวจสอบเงื่อนไขเส้นทางเพื่อคำนวณราคา
Step 4:แสดงผล
```
...
```text
เส้นทางตรงตามเงื่อนไขและค่าน้ำหนักเยอะ
```
