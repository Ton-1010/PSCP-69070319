...
Step 2:ตรวจสอบว่าเข้ากับเงื่อนไขที่ตั้งไว้ไหม
Step 3:แสดงSeasonที่ถูกต้องออกมา
```
...
```text
ใช้ตามวิธีแรกที่คิดไว้เลยแค่ต้องมาจัดตรงส่วนเงื่อนไขเพิ่มนิดหน่อยเพื่อให้คำนวณได้
```
